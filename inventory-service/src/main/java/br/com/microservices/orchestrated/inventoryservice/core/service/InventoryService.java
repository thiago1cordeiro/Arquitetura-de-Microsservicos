...
import br.com.microservices.orchestrated.inventoryservice.core.ultils.JsonUtil;
...
public class InventoryService {
    ...
    public void updateInventory(Event event) {
        try {
            ...
            log.error("Error trying update inventory: ", ex);
    ...
    private void createOrderEvent(Event event) {
        event
                .getPayload()
                .getProducts()
                .forEach(product -> {
                    var inventory = findInventoryProductCode(product.getProduct().getCode());
    ...
    private Inventory findInventoryProductCode(String productCode) {
